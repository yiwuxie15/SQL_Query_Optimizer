...
-------------SMJ------------------------------
SELECT soaps.network, stars.starid FROM soaps, stars WHERE soaps.soapid = stars.starid;

SELECT * FROM soaps, stars WHERE soaps.soapid = stars.starid;

SELECT soaps.network, stars.soupid FROM soaps, stars WHERE soaps.soapid = stars.soapid;
